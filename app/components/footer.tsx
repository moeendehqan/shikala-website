    ...
    <footer dir="rtl" className="border-t border-foreground/10 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* تماس */}
          <div>
            <h3 className="text-lg font-bold mb-3">ارتباط با ما</h3>
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 px-3 py-2 rounded-xl ring-1 ring-foreground/10 hover:bg-foreground/[0.04]"
              >
          ...
          {/* آدرس و سیاست‌ها */}
          <div>
            <h3 className="text-lg font-bold mb-3">آدرس و سیاست‌ها</h3>
          ...
          {/* نماد اعتماد */}
          <div>
            <h3 className="text-lg font-bold mb-3">نماد اعتماد و مجوزها</h3>
            <div className="flex items-center gap-4">
              <div className="rounded-xl ring-1 ring-foreground/10 bg-background/70 p-2">
